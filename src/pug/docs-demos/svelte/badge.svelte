    ...
    <Page>
      ...
      <Toolbar tabbar labels bottom>
        <Link tabLink="#tab-1" tabLinkActive>
          <Icon class="icon-fill" ios="f7:email_fill" aurora="f7:email_fill" md="material:email">
...
<script>
  import {App, View, Page, Navbar, NavRight, Link, Icon, Badge, Toolbar, List, ListItem} from 'framework7-svelte';
</script>
